...
class DrawingSheet(Base):
    ...
    drawing_no: Mapped[Optional[str]] = mapped_column(String(200), nullable=True)
    drawing_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    ...
    title_crop_path: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    title_crop_bbox: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    title_crop_status: Mapped[str] = mapped_column(String(32), nullable=False, default="pending")
    title_crop_error_code: Mapped[Optional[str]] = mapped_column(String(64), nullable=True)
    title_crop_error_message: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
